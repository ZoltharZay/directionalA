...
PROMPT_TEMPLATES = {
    # === SameSound 2D ===
    "SameSound_2D_Easy": "Estimate the 3D direction (azimuth°, elevation°) and loudness (0–1) of the dominant sound relative to a listener at (0,0,0) facing +Z.\n Task: Identify the direction of the audio relative to a listener at (0,0,0) facing +Z.\nOptions: Left, Right\n Provide your choice: ",
    "SameSound_2D_Mid": "Estimate the 3D direction (azimuth°, elevation°) and loudness (0–1) of the dominant sound relative to a listener at (0,0,0) facing +Z.\n Task: Identify the direction of the audio relative to a listener at (0,0,0) facing +Z.\nOptions: Left, Right, Up, Down \n Provide your choice: ",
    "SameSound_2D_Hard": "Task: Identify the direction of the audio.\nOptions: Left, Right, Front, Back.\n{caption}\nProvide your choice.",
    
    # === SameSound 3D ===
    "SameSound_3D_Easy": "Estimate the 3D direction (azimuth°, elevation°) and loudness (0–1) of the dominant sound relative to a listener at (0,0,0) facing +Z.\n Task: Identify the direction of the audio relative to a listener at (0,0,0) facing +Z.\nOptions: Left, Right, Up, Down, Forwards, backwards\n Provide your choice: ",
    "SameSound_3D_Hard": "Estimate the 3D direction (azimuth°, elevation°) and loudness (0–1) of the dominant sound relative to a listener at (0,0,0) facing +Z.\n Task: Identify the directions in which the audio moves relative to a listener at (0,0,0) facing +Z.\nOptions: Right-Left, Up-Down, Forward-Backwards\n Provide your choice:",
